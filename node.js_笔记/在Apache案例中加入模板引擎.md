...
<h1 id="header">D:\demo\www\ 的索引</h1>

<div id="parentDirLinkBox" style="display: block;">
  <a id="parentDirLink" class="icon up" href="/D:/demo/www/..">
...
<table>
  ...
  <tbody id="tbody">
	  {{each files}}
	  <tr><td data-value="apple/"><a class="icon dir" href="/D:/demo/www/apple/">{{$value}}/</a></td><td class="detailsColumn" data-value="0"></td><td class="detailsColumn" data-value="1597815177">2020/8/19 下午1:32:57</td></tr>
	  {{/each}}
  </tbody>
</table>
</body></html>
...
node 在Apache案例中加入模板引擎.js

得到server is running后
